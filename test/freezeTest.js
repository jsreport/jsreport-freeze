...
describe('freeze', () => {
  ...
  it('should allow iserts in default', async () => {
    return reporter.documentStore.collection('templates').insert({ name: 'foo' })
  })

  it('should allow update in default', async () => {
    await reporter.documentStore.collection('templates').insert({ name: 'foo' })
  ...
  it('should block iserts in freeze', async () => {
    ...
    return reporter.documentStore.collection('templates').insert({ name: 'foo' }).should.be.rejectedWith(/frozen/)
  })
